...
## Pass 3 — 2026-09-22 — scheduled run, branch `agent-loop/2026-09-22-claude-md-print-profile`
...
### L2 · `open` · carried forward, claimed

Two competing PRs (`#11`, `#12`) both bake instanced placements to close the
draw-call gap; not this pass's to resolve.

### L4 · `open` · carried forward, watching

`site/llms.txt` still claims the 0.9.0 line against five 0.8.0 packages —
release decision for the maintainer, re-checked and still accurate.
