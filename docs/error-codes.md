...
| `SCALE_TOO_LARGE` | `scene/scale-sanity` | warning | Largest world-space dimension is above the large-scale threshold (default 20 m); too big for AR placement. | Bake a uniform scale down; AR assets are usually 0.1–3 m. |
