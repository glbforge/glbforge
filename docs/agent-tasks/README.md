...
|---|---|---|---|
| [2026-09-22 badge → companion](2026-09-22-badge-companion.md) | 20260922 | transparent PNG → idle + reaction clip → desktop companion; profile pinned; every number from a tool | T1–T12 |
