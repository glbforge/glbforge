...
export const ERROR_CODES = {
  ...
  DIFF_ORIGIN_MOVED: spec('warning', 'The geometry moved relative to the origin: the bounds centre shifted beyond tolerance (warning), or the landmark was reclassified with the geometry in place (info).', 'Translate back if unintended, or set the origin deliberately.', 'diff/origin-moved'),
